...
@router.post('/login', tags=['Autenticação'], responses={
    200: {"model": str, "description": "Mensagem sucesso",
...
async def login(login_dto: LoginDTO = Body(...)):
...
@router.post('/register', status_code=201, tags=['Autenticação'], responses={
    201: {"model": str, "description": "Mensagem sucesso",
          "content": {"application/json": {"example": {"detail": "string"}}}},
